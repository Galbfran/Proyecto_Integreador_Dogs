...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/dogs_eacw`, {
...
Dog.belongsToMany(Temperaments, { through: 'Tabla_Int' });
Temperaments.belongsToMany(Dog, { through: 'Tabla_Int' });
